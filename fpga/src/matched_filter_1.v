// ============================================================
// Module:      matched_filter_1
// Description: Block cross-correlator for the 34-38 kHz LFM chirp
//              (Buoy 1). Accumulates a 2109-sample capture window
...
// Pipeline:    fir_filter_bank1 -> THIS -> peak_detector (ch 1)
